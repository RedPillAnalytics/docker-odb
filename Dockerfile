...
COPY --chown=oracle:dba $INSTALL_RSP $INSTALL_DB_BINARIES_FILE $INSTALL_DIR/
RUN curl -o $INSTALL_DIR/$INSTALL_FILE_1 https://s3.amazonaws.com/software.redpillanalytics.io/oracle/db/$INSTALL_FILE_1
